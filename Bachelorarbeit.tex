...
\begin{tikzpicture}
 \draw(-2.5,0.0)node[]{read$\_$Image}
		...
		(-0.75,0.0) -- (0.15,-1.0)
		(-1.5,-1.0)node[]{normalize}
		(0.15,-1.0)node[circle=2cm,fill = lightgray]{}
		 (0.15,-1.0) -- (1.0, -2.0)
		(-1.5,-2.0)node[]{execute$\_$Precondition }
		(1.00,-2.0)node[circle=2cm,fill = gray]{}
		(1.0, -2.0) -- (1.85, -3.0)
		(0.5,-3.0)node[]{normalize}
		(1.85,-3.0)node[circle=2cm,fill = lightgray]{}
		(1.85, -3.0) -- (2.7, -4.0)
		(1.5,-4.0)node[]{encode}
		(2.7,-4.0)node[circle=2cm,fill = gray]{}
		(2.7, -4.0) -- (3.55, -5.0)
		(3.55,-5.0)node[circle=2cm,fill = gray]{}
		(1.9,-5.0)node[]{write$\_$Binary};
		
		\draw(10.0,0.0)node[]{write$\_$Image}
		(8.40,0.0)node[circle=2cm,fill = gray]{}
		(8.40,0.0) -- (7.55,-1.0)
		(10.0,-1.0)node[]{execute$\_$Postcondition}
		(7.55,-1.0)node[circle=2cm,fill = gray]{}
		 (7.55,-1.0) --(6.70,-2.0)
		(8.0,-2.0)node[]{decode}
		(6.70,-2.0)node[circle=2cm,fill = gray]{}
		((6.70,-2.0) -- (5.85,-3.0)
		(7.50,-3.0)node[]{read$\_$Binary}
		(5.85,-3.0)node[circle=2cm,fill = gray]{};	
\end{tikzpicture}
\end{flushleft}
...
\subsubsection{Filtertyp 4: AVERAGE-3}
\begin{minipage}[h]{.6\textwidth}
...
\end{tabular}
\end{Algorithmus}
\subsubsection{Filtertyp 5: AVERAGE-4}
\begin{minipage}[h]{.6\textwidth}
...
\subsubsection{Filtertyp 6: AVERAGE-5}
\begin{minipage}[h]{.6\textwidth}
...
\subsubsection{Filtertyp 7: AVERAGE-6}
\begin{minipage}[h]{.6\textwidth}
...
\subsubsection{Filtertyp 8: AVERAGE-7}
\begin{minipage}[h]{.6\textwidth}
...
\subsubsection{Filtertyp 9: AVERAGE-8}
\begin{minipage}[h]{.6\textwidth}
...
Die Normalisierung erfolgt analog zur Normalisierung des UANS-Verfahren, in Algorithmus \ref{normalizeUANS} sind Rechts- bzw. Linksshift allerdings durch eine Dekrementierung bzw. Inkrementierung durch eins zu ersetzen.
