...
Abschließend geben wir das Verhalten der Entropie unter Verwendung einer Filterung und anschließender Normalisierung - also zur Laufzeit\footnote{Die hier aufgelisteten Daten entstammen der \CC -Implementierung. } - wieder. Zu Beginn beträgt die Entropie des betrachteten Bildes 7.766.
 Die zweite Spalte gibt den Wert der Entropie nach Verwendung eines Filters wieder, die dritte bzw. vierte Spalte dokumentiert die Entropie nach zusätzlicher Normalisierung 
\par
\vspace{1cm}
\begin{table}[h]
\begin{center}
